...
export declare const getTransactionFromRoutePlanZeroG: <DexIdTypes>(amountIn: Decimal, routePlan: DeserializeRoutePlan<DexIdTypes>[], wallet: string, slippage: number, connection: JsonRpcProvider) => Promise<{
    transactions: TransactionRequest[];
}>;
